...
class GlobalVariables: NSObject {
    ...
    class func loveBizhiUrl21920_1200 (url :String)->String{
        return url.stringByReplacingOccurrencesOfString("800", withString: "1920", options: nil, range: nil)
    }
    class func loveBizhiUrl21920_1200_2 (url :String)->String{
        return url.stringByReplacingOccurrencesOfString("800", withString: "480", options: nil, range: nil).stringByReplacingOccurrencesOfString("1200", withString: "300", options: nil, range: nil)
    }
